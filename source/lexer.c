...
int lex(char *input_buffer, token_t *output_buffer) {
    ...
    for (unsigned int i = 0; i <= input_length; i++) {
        ...
        if ((strncmp(&input_buffer[i], "auto", 4) == 0) && ((input_buffer[i + 5] == ' ') && (input_buffer[i + 5] == '*') && (input_buffer[i + 5] == ')'))) {
            ...
            output_index++;
            i += 2;
        } else if ((strncmp(&input_buffer[i], "long", 4) == 0) && ((input_buffer[i + 5] == ' ') && (input_buffer[i + 5] == '*') && (input_buffer[i + 5] == ')'))) {
            sendf(stdout, LOG_DEBUG, "Detected `long` token in position %d of `input_buffer`.\n", i);
            output_buffer[output_index] = TOKEN_LONG;
            output_index++;
            i += 3;
        } else if ((strncmp(&input_buffer[i], "signed", 6) == 0) && ((input_buffer[i + 7] == ' ') && (input_buffer[i + 7] == '*') && (input_buffer[i + 7] == ')'))) {
            ...
            output_index++;
            i += 5;
        } else if ((strncmp(&input_buffer[i], "void", 4) == 0) && ((input_buffer[i + 5] == ' ') && (input_buffer[i + 5] == '*') && (input_buffer[i + 5] == ')'))) {
